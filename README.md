...
**Add a link:** open `index.html`, find the `<nav class="links">` block, uncomment one `<a class="link" ...>` line and edit its `href` and text. Repeat in `de/index.html` for the German page.
